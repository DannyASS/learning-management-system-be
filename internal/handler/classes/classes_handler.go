...
func (ctrl *ClassesHandler) GetAvailableModulDash(c *fiber.Ctx) error {
	return utils.TryCatch(c, func() error {
		id := c.Params("id")
		idUint, err1 := strconv.ParseUint(id, 10, 64)
		if err1 != nil {
		...
		data, err := ctrl.uc.GetAvailableModulDash(int(idUint), teacherId)
		if err != nil {
...
func (ctrl *ClassesHandler) GetAvailablecourse(c *fiber.Ctx) error {
	return utils.TryCatch(c, func() error {
		id := c.Params("id")
		idUint, err1 := strconv.ParseUint(id, 10, 64)
		if err1 != nil {
		...
		data, err := ctrl.uc.GetCourseAvailable(teacherId, int(idUint))
		if err != nil {
